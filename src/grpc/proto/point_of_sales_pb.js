...
proto.data.PointOfSales.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    help: jspb.Message.getFieldWithDefault(msg, 4, ""),
    ismodifyprice: jspb.Message.getBooleanFieldWithDefault(msg, 5, false),
...
/**
 * optional bool isPOSRequiredPIN = 6;
 * @return {boolean}
 */
...
/**
 * optional SalesRepresentative salesRepresentative = 7;
...
proto.data.PointOfSales.prototype.getSalesrepresentative = function() {
  return /** @type{?proto.data.SalesRepresentative} */ (
    jspb.Message.getWrapperField(this, proto_core_functionality_pb.SalesRepresentative, 7));
};
...
/**
 * optional BusinessPartner templateBusinessPartner = 8;
...
proto.data.PointOfSales.prototype.getTemplatebusinesspartner = function() {
  return /** @type{?proto.data.BusinessPartner} */ (
    jspb.Message.getWrapperField(this, proto_core_functionality_pb.BusinessPartner, 8));
};
 ...
 * @return {string}
 */
proto.data.UpdateOrderLineRequest.prototype.getOrderuuid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.data.UpdateOrderLineRequest.prototype.setOrderuuid = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
...
/**
 * optional SalesRepresentative salesRepresentative = 4;
 * @return {?proto.data.SalesRepresentative}
 */
